    ...
    */
    class Sound
    {
      ...
      public:
        ...
        FMOD_RESULT F_API setMusicChannelVolume  (int channel, float volume_ch0);
        FMOD_RESULT F_API getMusicChannelVolume  (int channel, float *volume_ch0);
    ...
    */
    class ChannelControl
    {
      ...
      public:
        ...
        FMOD_RESULT F_API setVolume              (float volume_ch0);
        FMOD_RESULT F_API getVolume              (float *volume_ch0);
        ...
        FMOD_RESULT F_API addFadePoint           (unsigned long long dspclock, float volume_ch0);
        FMOD_RESULT F_API setFadePointRamp       (unsigned long long dspclock, float volume_ch0);
    ...
    */
    class DSPConnection
    {
      ...
      public:
        ...
        FMOD_RESULT F_API setMix                (float volume_ch0);
        FMOD_RESULT F_API getMix                (float *volume_ch0);
        FMOD_RESULT F_API setMixMatrix          (float *matrix, int outchannels, int inchannels, int inchannel_hop = 0);
        FMOD_RESULT F_API getMixMatrix          (float *matrix, int *outchannels, int *inchannels, int inchannel_hop = 0);
